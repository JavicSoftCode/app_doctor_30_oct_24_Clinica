...
from doctor.utils import valida_cedula, validate_birth_date, validate_full_name, \
  validate_codigo_unico_doctor, validate_and_format_cell_number, validate_sueldo, validate_cantidad, validate_precio, generate_valid_diagnosis_code
...
class Paciente(models.Model):
  ...
  telefono = models.CharField(max_length=20, verbose_name="Teléfono(s)", validators=[validate_and_format_cell_number],
                              unique=True)
...
class Empleado(models.Model):
  # Nombre del empleado
  nombres = models.CharField(max_length=100, verbose_name="Nombre del Empleado", validators=[validate_full_name])
  # Apellido del empleado
  apellidos = models.CharField(max_length=100, verbose_name="Apellido del Empleado", validators=[validate_full_name])
...
class TipoCategoria(models.Model):
  ...
  nombre = models.CharField(max_length=255, verbose_name="Nombre del Examen", unique=True)
