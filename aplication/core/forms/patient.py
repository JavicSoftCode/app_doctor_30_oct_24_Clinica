  ...
  class Meta:
    ...
    widgets = {
      ...
      "medicacion_actual": forms.TextInput(
        attrs={
          "placeholder": "Ingrese si tiene medicacion actual",
      ...
      "antecedentes_personales": forms.TextInput(
        attrs={
          "placeholder": "Ingrese si tiene antecedentes personales",
      ...
      "antecedentes_familiares": forms.TextInput(
        attrs={
          "placeholder": "Ingrese si tiene antecedentes familiares",
