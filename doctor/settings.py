...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ing.javiersistem02ejqp@gmail.com'  # Cambia a tu correo
EMAIL_HOST_PASSWORD = 'awgg mrsa mbrt baqv'  # Cambia a tu contraseña o usa una contraseña de aplicación
...
CELERY_BEAT_SCHEDULE = {
  'enviar_recordatorio_cada_minuto': {
    'task': 'aplication.attention.tasks.enviar_recordatorio_cita',
